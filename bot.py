...
# ==================== পার্মানেন্ট বাটন (অ্যাডমিন বাটন সহ) ====================
def get_permanent_keyboard():
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("👑 অ্যাডমিন প্যানেল", callback_data="admin_panel")],  # অ্যাডমিন বাটন
...
def main():
    ...
    application.add_handler(CommandHandler("admin", admin_command))  # /admin কমান্ড
    ...
    print(f"📌 /admin কমান্ড ব্যবহার করুন অথবা বাটনে ক্লিক করুন")
