...
# ==================== কনফিগারেশন ====================
BOT_TOKEN = "8707267313:AAGAanwASEjiYime3MldFT5DYRg865at_sc"
...
def create_user(user_id, referrer_id=None):
    ...
    user_data = {
        ...
        "used_promos": []  # ইউজার কোন প্রোমো ব্যবহার করেছে
    }
...
def create_promo_code(code, credits, max_uses, created_by):
    ...
    promo_data[code] = {
        ...
        "users": []  # যারা ব্যবহার করেছে তাদের আইডি
    }
...
def use_promo_code(user_id, code):
    ...
    # ইউজার আগে ব্যবহার করেছে কিনা চেক
    ...
    if add_credits(user_id, promo["credits"]):
        ...
        # ইউজারের ইউজড প্রোমো লিস্ট আপডেট
...
def get_permanent_keyboard(user_id=None):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🎁 ইউজ প্রোমো কোড", callback_data="use_promo")],  # ইউজার প্রোমো বাটন
...
def get_admin_keyboard():
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🎁 প্রোমো কোড তৈরি", callback_data="admin_create_promo")],  # প্রোমো তৈরি বাটন
        [InlineKeyboardButton("📋 প্রোমো কোড তালিকা", callback_data="admin_promo_list")],  # প্রোমো তালিকা
...
👤 ইউজার: `{user_id}`
🎁 কোড: `{text.upper()}`
💰 ক্রেডিট: {get_user(user_id)['credits']}
━━━━━━━━━━━━━━━━━━━
""",
                        parse_mode="Markdown"
                    )
